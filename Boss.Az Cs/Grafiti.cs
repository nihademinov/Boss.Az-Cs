...
namespace Boss.Az_Cs
{
    static  internal class Grafiti
    {
        public static void Print_Logo_()
        {
            ...
            Console.WriteLine();
            Console.WriteLine(@"                                                               _       U  ___ u   ____              _   _     ");
            Console.WriteLine(@"                                                              |""|       \/""_ \/U /""___|u   ___     | \ |""|    ");
            Console.WriteLine(@"                                                            U | | u     | | | |\| |  _ /  |_""_|   <|  \| |>   ");
            Console.WriteLine(@"                                                             \| |/__.-,_| |_| | | |_| |    | |    U| |\  |u   ");
            Console.WriteLine(@"                                                              |_____|\_)-\___/   \____|  U/| |\u   |_| \_|    ");
            Console.WriteLine(@"                                                              //  \\      \\     _)(|_.-,_|___|_,-.||   \\,-. ");
            Console.WriteLine(@"                                                             (_"")(""_)    (__)   (__)__)\_)-' '-(_/ (_"")  (_/  ");
            Console.WriteLine();
            Console.WriteLine();
            Console.WriteLine();
            Console.WriteLine();
        ...
        public static void Print_Registiration()
        {
            Console.ForegroundColor = ConsoleColor.Cyan;
        ...
        public static void Print_BossAzWorker()
        {
            Console.Clear();
